...
| 主分支 | `main` |
| 已推送提交 | `40fb540068efc255be9648d1367c938ab254028f` |
| 已部署提交 | `40fb540068efc255be9648d1367c938ab254028f`，2026-09-04 已验证 |
...
| 下一步 | 在本地按 `docs/CITY_PRACTICE_GUIDE.md` 试玩；已有账号从「设置 → 进城实操引导」进入；观察首个可参与故事的等待时间。跨设备前提交所需改动，并决定两份素材草稿是否纳入 Git |
