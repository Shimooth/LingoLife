...
const faces:Record<string,string>={
 oval:'M160 68C126 68 116 91 117 127c1 39 17 68 43 75 26-7 42-36 43-75 1-36-9-59-43-59Z',
 round:'M160 70c-38 0-48 24-47 59 1 37 18 65 47 68 29-3 46-31 47-68 1-35-9-59-47-59Z',
 heart:'M160 68c-37 0-48 22-46 58 2 34 18 68 46 78 28-10 44-44 46-78 2-36-9-58-46-58Z',
 square:'M160 70c-36 0-45 18-45 52v42l22 33h46l22-33v-42c0-34-9-52-45-52Z',
 long:'M160 65c-31 0-40 22-39 62 1 44 15 75 39 82 24-7 38-38 39-82 1-40-8-62-39-62Z',
}
...
export function AvatarStage({mood='idle',avatar=defaultAvatar,compact=false,scene=false}:{mood?:Mood;avatar?:AvatarConfig;compact?:boolean;scene?:boolean}){
 ...
 return <section className={`stage avatar-stage ${compact?'compact':''} ${scene?'scene-avatar':''}`}><svg className="room-art" viewBox={scene?'70 30 180 315':'0 0 320 390'} role="img" aria-label={`Character feeling ${mood}`}>
  ...
  <motion.g animate={reduce?undefined:{y:mood==='happy'?[0,-6,0]:[0,2,0]}} transition={{duration:mood==='happy'?1.4:3.8,repeat:Infinity}}>
   <path d="M116 315h43l-4 70h-48zM161 315h43l9 70h-48z" fill="#4f5968"/><path d="M158 321v64M112 380h43v10h-51q-5-7 8-10m55 0h43q13 4 5 10h-50z" fill="#353a43" stroke="#353a43" strokeWidth="3" strokeLinecap="round"/>
   <path d="M111 250Q91 275 87 318M209 250q20 25 24 68" fill="none" stroke={avatar.skin} strokeWidth="17" strokeLinecap="round"/><path d="M112 249Q99 263 96 282M208 249q13 14 16 33" fill="none" stroke={avatar.outfitColor} strokeWidth="27" strokeLinecap="round"/><ellipse cx="86" cy="326" rx="10" ry="13" fill={avatar.skin}/><ellipse cx="234" cy="326" rx="10" ry="13" fill={avatar.skin}/>
   <path d="M141 170c3 26-4 50-10 67h58c-6-17-13-41-10-67z" fill={avatar.skin}/><path d="M143 180q17 14 34 0v30q-17 14-34 0z" fill="#9f5f55" opacity=".1"/>
   <path d={outfits[avatar.outfit]||outfits.sweater} fill={avatar.outfitColor}/><path d="M118 245q42-27 84 0" fill="none" stroke="#fff" strokeOpacity=".24" strokeWidth="3"/><ClothingDetails kind={avatar.outfit} color={avatar.outfitColor}/>
   <path d={hair[avatar.hair]||hair.waves} fill={avatar.hairColor} stroke={avatar.hairColor} strokeWidth="16" strokeLinecap="round"/>
   <ellipse cx="116" cy="137" rx="8" ry="13" fill={avatar.skin} stroke="#995f55" strokeOpacity=".18"/><ellipse cx="204" cy="137" rx="8" ry="13" fill={avatar.skin} stroke="#995f55" strokeOpacity=".18"/>
   <path d={faces[avatar.face]||faces.oval} fill={avatar.skin} stroke="#8f5b52" strokeOpacity=".18" strokeWidth="1.5"/><path d="M130 158q30 22 60 0" fill="none" stroke="#9c6257" strokeOpacity=".08" strokeWidth="10" strokeLinecap="round"/><path d={hair[avatar.hair]||hair.waves} fill={avatar.hairColor}/>
