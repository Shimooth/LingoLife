...
export function practicePresentation(data:CityPractice|null,language:'zh'|'en'){
 ...
 if(storyHasOutcome(story))return {kind:'recap',title:zh?'这是一段已发生的故事':'This is a past moment',button:zh?'回顾这件事':'Review this moment',detail:zh?'打开回顾，点击「查看结果」继续下一步。':'Open the recap and choose “See what happened” to continue.'}
