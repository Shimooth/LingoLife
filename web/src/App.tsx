...
export default function App({user,initialQuota,onLogout}:{user:User;initialQuota:Quota;onLogout:()=>void}){
 ...
 const currentPlace=currentResident?.is_home?t('map.home'):(currentLocation?locationCopy(currentLocationAsset,language).name:t('map.currentLocation'))
