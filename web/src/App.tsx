...
import type {Feedback,Message,Mood,Stats} from './types'
...
export default function App(){
 ...
 return <main className="shell"><motion.section className="room" initial={reduce?false:{opacity:0,y:12}} animate={{opacity:1,y:0}}>
  <header><div><p className="eyebrow">Emma's room</p><h1>A quiet evening</h1></div><div className={`presence ${ready?'online':'offline'}`} role="status"><i/>{ready?'Emma is here':error?'Offline':'Connecting'}</div></header>
