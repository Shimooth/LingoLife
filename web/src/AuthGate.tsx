...
export function AuthGate(){
 ...
 if(checking)return <BrandedStartupShell message={language==='zh'?'正在确认云端身份…':'Checking your sky pass…'}/>
 if(user&&quota)return <Suspense fallback={<BrandedStartupShell message={language==='zh'?'正在准备天空之城…':'Preparing the sky city…'}/>}><App user={user} initialQuota={quota} onLogout={()=>{setUser(null);setQuota(null)}}/></Suspense>
