...
const asset=(id:string,seed:LocationSeed):LocationAsset=>({
 id,icon:seed.icon,image:`/assets/locations/${seed.scene}.jpg`,imagePosition:seed.position,accent:seed.accent,
...
const seeds:Record<KnownLocationId,LocationSeed>={
 ...
 harbor_mall:{icon:'mall',scene:'commerce',accent:'#a66c78',position:'70% center',zh:['港湾商场','购物中心','靠近港口的综合商场，从日用品到临时礼物都能找到，也常有快闪活动。','10:00–22:00',['生活商店','中庭活动','港景露台']],en:['Harbor Mall','Shopping center','A harbor-side mall for daily needs, last-minute gifts, and the occasional pop-up event.','10:00–22:00',['Everyday shops','Atrium events','Harbor terrace']]},
 ...
 harbor_restaurant:{icon:'restaurant',scene:'commerce',accent:'#9e563f',position:'90% center',zh:['港湾餐厅','餐厅','能看到港灯的家庭餐厅，晚餐时间热闹，深夜则适合安静地聊重要事情。','11:00–23:00',['海港晚景','分享菜单','安静卡座']],en:['Harbor Restaurant','Restaurant','A family restaurant overlooking the harbor lights—lively at dinner, quiet enough for important talks later.','11:00–23:00',['Harbor view','Sharing menu','Quiet booths']]},
 ...
 south_harbor:{icon:'harbor',scene:'nature',accent:'#356f82',position:'80% center',zh:['南岸港口','滨水区域','仍在使用的小型城市港口，白天务实忙碌，傍晚则被灯和海风软化。','05:00–23:00',['城市码头','观景堤岸','渡船站']],en:['South Harbor','Waterfront','A working city harbor—practical and busy by day, softened by lights and sea air after dusk.','05:00–23:00',['City piers','View promenade','Ferry landing']]},
...
export const HOME_LOCATION_ASSET:LocationAsset={
 id:'home',icon:'community',image:'/assets/locations/home.jpg',accent:'#b66e4d',
...
export function getLocationAsset(id?:string|null,kind?:string):LocationAsset{
 if(id?.startsWith('home-')||id==='home')return HOME_LOCATION_ASSET
